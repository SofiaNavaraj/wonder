...
import sa.directtoweb.interfaces.SADEditRelationshipPageInterface;
 ...
 * @author davidleber
 */
public class SADEditRelationshipPage extends ERD2WPage implements
		SADEditRelationshipPageInterface, SelectPageInterface {
	...
	public SADEditRelationshipPage(WOContext context) {
		super(context);
	}
	...
	@Override
	public void sleep() {
		NSNotificationCenter.defaultCenter().removeObserver(this, SADActionButton.BUTTON_PERFORMED_DELETE_ACTION, null);
		super.sleep();
	}
