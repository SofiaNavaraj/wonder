...
/**
 * Base Class for the SAD action buttons
 * 
 * @binding object
 ...
 *
 */
public class SADActionButton extends ERDCustomComponent {
    ...
    public static final String BUTTON_PERFORMED_DELETE_ACTION = "SADActionButtonPerformedDelete";
    public static final String BUTTON_PERFORMED_EDIT_ACTION = "SADActionButtonPerformedEdit";
    public static final String BUTTON_PERFORMED_SELECT_ACTION = "SADActionButtonPerformedSelect";
    public static final String BUTTON_PERFORMED_INSPECT_ACTION = "SADActionButtonPerformedInspect";    
	...
	public SADActionButton(WOContext context) {
		super(context);
