...
public class ERBActionButton extends ERDCustomComponent {
    ...
    public static final String BUTTON_PERFORMED_DELETE_ACTION = "ERBActionButtonPerformedDelete";
    public static final String BUTTON_PERFORMED_EDIT_ACTION = "ERBActionButtonPerformedEdit";
    public static final String BUTTON_PERFORMED_SELECT_ACTION = "ERBActionButtonPerformedSelect";
    public static final String BUTTON_PERFORMED_INSPECT_ACTION = "ERBActionButtonPerformedInspect";    
	...
	public ERBActionButton(WOContext context) {
		super(context);
	}
