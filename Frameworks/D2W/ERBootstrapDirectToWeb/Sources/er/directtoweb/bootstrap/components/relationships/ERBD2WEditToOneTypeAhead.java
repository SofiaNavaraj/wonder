...
import er.directtoweb.bootstrap.components.buttons.ERBActionButton;
...
public class ERBD2WEditToOneTypeAhead extends ERDCustomEditComponent {
	...
	public ERBD2WEditToOneTypeAhead(WOContext context) {
        super(context);
    }
	...
	public void awake() {
		NSNotificationCenter.defaultCenter().addObserver(
				...
				ERBActionButton.BUTTON_PERFORMED_DELETE_ACTION, null);
		super.awake();
	}
